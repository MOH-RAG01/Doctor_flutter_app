...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  specializationLoading,TResult Function( SpecializationResponse specializationResponse)?  specializationLoaded,TResult Function( String message)?  specializationError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return specializationError(_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  specializationLoading,required TResult Function( SpecializationResponse specializationResponse)  specializationLoaded,required TResult Function( String message)  specializationError,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  specializationLoading,TResult? Function( SpecializationResponse specializationResponse)?  specializationLoaded,TResult? Function( String message)?  specializationError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case SpecializationLoading() when specializationLoading != null:
return specializationLoading();case SpecializationLoaded() when specializationLoaded != null:
